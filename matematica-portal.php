  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Dashboard Portal web Matemática divertida</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <?php include('include/matematica-header-portal.php'); ?>
            ...
            <div class="card card-primary card-outline">
              <div class="card-header">
                ...
                <div class="card-tools">
                  ...
                  <a href="2019\matematicaDivertida-portal.html" target="blank"><button type="button" class="btn btn-default btn-sm active" data-toggle="on">2019</button></a>
...
<script type="text/javascript" src="charts\metematicadivertida\chartsPortalWeb.js"></script>
