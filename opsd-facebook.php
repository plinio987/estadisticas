  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Dashboard Facebook OPSD</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <?php include('include/opsd-header-facebook.php'); ?>
              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                  ...
                  <div class="btn-group" id="realtime" data-toggle="btn-toggle">
                    <a href="2019\opsd-facebook.html" target="blank"><button type="button" class="btn btn-default btn-sm active" data-toggle="on">2019</button></a>
                    <a href="2018\Opsd-facebook.html" target="blank"><button type="button" class="btn btn-default btn-sm" data-toggle="off">2018</button></a>
                  </div>
                </div>
              </div>
              <div class="card-body">
...
<script type="text/javascript" src="charts/canvasjs.js"></script>
    <script type="text/javascript" src="charts\opsd\chartsFacebook.js"></script>
