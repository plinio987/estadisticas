<a href="dashboard.php" class="brand-link">
      <img src="dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Comunicación Digital</span>
    </a>
           ...
           <ul class="nav nav-treeview">
               <!-- <li class="nav-item has-treeview">
                    ...
                    <li class="nav-item">
                      ...
                      <li class="nav-item">
                        <a href="gabsocial-twitter.php" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                            <p>Twitter</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="gabsocial-facebook.php" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                            <p>Facebook</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="gabsocial-portal.php" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                            <p>Portal web</p>
                        </a>
                      </li>
                ...
                <li class="nav-item has-treeview">
                    ...
                    <i class="far fa-circle nav-icon text-success"></i>
                      <p> Prosoli<i class="right fas fa-angle-left"></i></p>
                    </a>
                    <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="prosoli.php" class="nav-link">
                        <i class="fa fa-home nav-icon text-success"></i>
                          <p>Home</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="prosoli-facebook.php" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                            <p>Facebook</p>
                        </a>
                      </li>
                ...
                <li class="nav-item has-treeview">
                    ...
                    <i class="far fa-circle nav-icon text-verde"></i>
                      <p> CTC<i class="right fas fa-angle-left"></i></p>
                    </a>
                    <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="ctc.php" class="nav-link">
                        <i class="fa fa-home nav-icon text-verde"></i>
                          <p>Home</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="ctc-facebook.php" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                            <p>Facebook</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="ctc-twitter.php" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                            <p>Twitter</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="ctc-instagram.php" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                            <p>Instagram</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="ctc-portal.php" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                            <p>Portal web</p>
                        </a>
                      </li>
               ...
               <!-- <li class="nav-item has-treeview">
                    ...
                    <li class="nav-item">
                        <a href="siuben.php" class="nav-link">
                        <i class="fa fa-home nav-icon text-siuben"></i>
                          <p>Home</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="siuben-facebook.php" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                            <p>Facebook</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="siuben-twitter.php" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                            <p>Twitter</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="siuben-portal.php" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                            <p>Portal web</p>
                        </a>
                      </li>
                ...
                <li class="nav-item has-treeview">
                    ...
                    <i class="far fa-circle nav-icon text-adess"></i>
                      <p>Adess<i class="right fas fa-angle-left"></i></p>
                    </a>
                    <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="adess.php" class="nav-link">
                        <i class="fa fa-home nav-icon text-adess"></i>
                          <p>Home</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="adess-facebook.php" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                            <p>Facebook</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="adess-twitter.php" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                            <p>Twitter</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="adess-portal.php" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                            <p>Portal web</p>
                        </a>
                      </li>
               ...
               <li class="nav-item has-treeview">
                    ...
                    <li class="nav-item">
                        <a href="bij.php" class="nav-link">
                        <i class="fa fa-home nav-icon text-warning"></i>
                          <p>Home</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="bij-facebook.php" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                            <p>Facebook</p>
                        </a>
                      </li>
                      ...
                      <li class="nav-item">
                        <a href="bij-portal.php" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                            <p>Portal web</p>
                        </a>
                      </li>
          ...
          <li class="nav-item has-treeview">
           ...
           <!--<li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                      ...
                      <li class="nav-item">
                        <a href="opsd-facebook.php" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                            <p>Facebook</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="opsd-twitter.php" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                            <p>Twitter</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="opsd-instagram.php" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                            <p>Instagram</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="opsd-portal.php" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                            <p>Portal web</p>
                        </a>
                      </li>
                ...
                <li class="nav-item has-treeview">
                    ...
                    <i class="far fa-circle nav-icon text-danger"></i>
                      <p>Cultura Ciudadana<i class="right fas fa-angle-left"></i></p>
                    </a>
                    <ul class="nav nav-treeview">
                      <li class="nav-item">
                        <a href="cultura.php" class="nav-link">
                      ...
                      <li class="nav-item">
                        <a href="cultura-facebook.php" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                            <p>Facebook</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="cultura-instagram.php" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                            <p>Instagram</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="cultura-portal.php" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                            <p>Portal web</p>
                        </a>
                      </li>
              ...
              <li class="nav-item has-treeview">
                    ...
                    <i class="far fa-circle nav-icon text-naranja "></i>
                      <p>JQP<i class="right fas fa-angle-left"></i></p>
                    </a>
                    <ul class="nav nav-treeview">
                      <li class="nav-item">
                        <a href="jqp.php" class="nav-link">
                        <i class="fa fa-home nav-icon text-naranja"></i>
                          <p>Home</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="jqp-facebook.php" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                            <p>Facebook</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="jqp-instagram.php" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                            <p>Instagram</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="jqp-portal.php" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                            <p>Portal web</p>
                        </a>
                      </li>
               ...
               <!--<li class="nav-item has-treeview">
                 ...
                 <li class="nav-item has-treeview">
                    ...
                    <li class="nav-item">
                        <a href="cedimu.php" class="nav-link">
                        <i class="fa fa-home nav-icon text-rosa"></i>
                          <p>Home</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="cedimu-facebook.php" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                            <p>Facebook</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="cedimu-portal.php" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                            <p>Portal web</p>
                        </a>
                      </li>
                ...
                <!--<li class="nav-item has-treeview">
                    ...
                    <li class="nav-item">
                        <a href="tiemposolidario.php" class="nav-link">
                        <i class="fa fa-home nav-icon text-tiempo"></i>
                          <p>Home</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="tiemposolidario-facebook.php" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                            <p>Facebook</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="tiemposolidario-instagram.php" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                            <p>Instagram</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="tiemposolidario-portal.php" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                            <p>Portal web</p>
                        </a>
                      </li>
