                    ...
                    <a href="opsd-portal.php">
                        ...
                        <!-- fix for small deopsds only -->
                        <div class="clearfix hidden-md-up"></div>
                        <div class="col-12 col-sm-2 col-md-2">
                        <a href="opsd-twitter.php">
                            <div class="info-box mb-3">
                                <span class="info-box-icon bg-secondary elevation-1"><i class="fab fa-twitter-square"></i></span>
                                <div class="info-box-content">
