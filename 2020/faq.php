      ...
      <div class="accordion" id="accordionExample">
          ...
          <div class="card">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
              <div class="card-body">
              Es el grado de compromiso que consigue una cuenta con sus seguidores en las redes sociales. Se obtiene dividiendo el total de interacciones entre el número de seguidores de una cuenta.
              </div>
            </div>
          </div>
          <div class="card">
            ...
            <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
              <div class="card-body">
              Es el grado de compromiso que consigue una cuenta de RRSS con el alcance de sus publicaciones, es un engagement más acertado por qué involucra todas las posibles interacciones, se obtiene dividiendo el total de interacciones entre el alcance de una cuenta.
              </div>
            </div>
          </div>
          ...
          <div class="card">
            ...
            <div id="collapse1" class="collapse" aria-labelledby="heading5" data-parent="#accordionExample">
              <div class="card-body">
              Es el grado de interacción de los post de una cuenta. Se obtiene dividiento el total de post entre en total de interracciones.
              </div>
            </div>
          </div>
          ...
          <div class="card">
            ...
            <div id="collapse4" class="collapse" aria-labelledby="heading4" data-parent="#accordionExample">
              <div class="card-body">
              Es el número de veces que el nombre del usuario de RRSS ha sido mencionado.
              </div>
            </div>
          </div>
          ...
          <div class="card">
            ...
            <div id="collapse5" class="collapse" aria-labelledby="heading5" data-parent="#accordionExample">
              <div class="card-body">
               Es el número de personas que han visitado el perfil en las RRSS.
              </div>
            </div>
          </div>
          ...
          <div class="card">
            ...
            <div id="collapse6" class="collapse" aria-labelledby="heading5" data-parent="#accordionExample">
              <div class="card-body">
               Es el número de veces que se hizo clic en los enlaces de los Tweets. Esto incluye los enlaces en hashtags y la mención de otros usuarios en los Tweets.
              </div>
            </div>
          </div>
          ...
          <div class="card">
            ...
            <div id="collapse7" class="collapse" aria-labelledby="heading5" data-parent="#accordionExample">
              <div class="card-body">
              Es la sumatoria de todas las interacciones de una cuenta, esto incluye: Me gusta, Retweets, Comentarios y clics en publicaciones.
              </div>
            </div>
          </div>
