    ...
    var chart30 = new CanvasJS.Chart("promedioMeGusta", {
        ...
        data: [{
                ...
                dataPoints: [
                    ...
                    { x: new Date(2020, 1), y: 0.13 },
                    { x: new Date(2020, 2), y: 0.14 },
                    { x: new Date(2020, 3), y: 0.11 },
                    { x: new Date(2020, 4), y: 0.30 },
                    { x: new Date(2020, 5), y: 0.37 },
                    { x: new Date(2020, 6), y: 0.11 },
                    { x: new Date(2020, 7), y: 0 },
                    { x: new Date(2020, 8), y: 0 },
                    { x: new Date(2020, 9), y: 0 },
                    { x: new Date(2020, 10), y: 0 },
...

            {
                ...
                dataPoints: [
                    ...
                    { x: new Date(2020, 1), y: 0.03 },
                    { x: new Date(2020, 2), y: 0.02 },
                    { x: new Date(2020, 3), y: 0.01 },
                    { x: new Date(2020, 4), y: 0.02 },
                    { x: new Date(2020, 5), y: 0.08 },
