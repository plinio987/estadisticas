window.onload = function() {
    ...
    var chart20 = new CanvasJS.Chart("averagelikes", {
        ...
        data: [{
                ...
                xValueFormatString: "MMMM YYYY",
                dataPoints: [
                    { x: new Date(2020, 0), y: 27.77 },
                    { x: new Date(2020, 1), y: 0 },
                    { x: new Date(2020, 2), y: 40.22 },
                    { x: new Date(2020, 3), y: 48.12 },
                    { x: new Date(2020, 4), y: 12.31 },
                    { x: new Date(2020, 5), y: 38.07 },
                    { x: new Date(2020, 6), y: 20.21 },
                    { x: new Date(2020, 7), y: 0 },
                    { x: new Date(2020, 8), y: 0 },
                    { x: new Date(2020, 9), y: 0 },
                    { x: new Date(2020, 10), y: 0 },
...

            {
                ...
                yValueFormatString: "###0.00'%'",
                dataPoints: [
                    { x: new Date(2020, 0), y: 0.41 },
                    { x: new Date(2020, 1), y: 0 },
                    { x: new Date(2020, 2), y: 1.53 },
                    { x: new Date(2020, 3), y: 1.83 },
                    { x: new Date(2020, 4), y: 0.31 },
                    { x: new Date(2020, 5), y: 1.03 },
                    { x: new Date(2020, 6), y: 0.83 },
                    { x: new Date(2020, 7), y: 0 },
                    { x: new Date(2020, 8), y: 0 },
                    { x: new Date(2020, 9), y: 0 },
                    { x: new Date(2020, 10), y: 0 },
