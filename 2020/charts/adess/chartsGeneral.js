    ...
    var chart1 = new CanvasJS.Chart("alcanceGeneral", {
        ...
        data: [{
                ...
                dataPoints: [
                    ...
                    { x: new Date(2020, 5), y: 3.76 },
                    { x: new Date(2020, 6), y: 3.17 },
...

            {
                ...
                dataPoints: [
                    ...
                    { x: new Date(2020, 5), y: 4168323 },
                    { x: new Date(2020, 6), y: 10439416 },
                    { x: new Date(2020, 7), y: 0 },
                    { x: new Date(2020, 8), y: 0 },
                    { x: new Date(2020, 9), y: 0 },
                    { x: new Date(2020, 10), y: 0 },
    ...
    var chart2 = new CanvasJS.Chart("totalSeguidores", {
        ...
        data: [{
            ...
            dataPoints: [
                ...
                { x: new Date(2020, 5), y: 17141 },
                { x: new Date(2020, 6), y: 22871 },
                { x: new Date(2020, 7), y: 0 },
                { x: new Date(2020, 8), y: 0 },
                { x: new Date(2020, 9), y: 0 },
                { x: new Date(2020, 10), y: 0 },
