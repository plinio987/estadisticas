window.onload = function() {
    ...
    var chart = new CanvasJS.Chart("engagement", {
        ...
        data: [{
                ...
                dataPoints: [
                    ...
                    { x: new Date(2020, 5), y: 8.44 },
                    { x: new Date(2020, 6), y: 9.30 },
...

            {
                ...
                dataPoints: [
                    ...
                    { x: new Date(2020, 5), y: 3.40 },
                    { x: new Date(2020, 6), y: 3.40 },
                    { x: new Date(2020, 7), y: 0 },
                    { x: new Date(2020, 8), y: 0 },
                    { x: new Date(2020, 9), y: 0 },
                    { x: new Date(2020, 10), y: 0 },
    ...
    var chart20 = new CanvasJS.Chart("averagelikes", {
        ...
        data: [{
                ...
                xValueFormatString: "MMMM YYYY",
                dataPoints: [
                    { x: new Date(2020, 0), y: 12.69 },
                    { x: new Date(2020, 1), y: 9.46 },
                    { x: new Date(2020, 2), y: 9.14 },
                    { x: new Date(2020, 3), y: 5.78 },
                    { x: new Date(2020, 4), y: 5.33 },
                    { x: new Date(2020, 5), y: 4.05 },
                    { x: new Date(2020, 6), y: 8.66 },
                    { x: new Date(2020, 7), y: 0 },
                    { x: new Date(2020, 8), y: 0 },
                    { x: new Date(2020, 9), y: 0 },
                    { x: new Date(2020, 10), y: 0 },
...

            {
                ...
                yValueFormatString: "###0.00'%'",
                dataPoints: [
                    { x: new Date(2020, 0), y: 0.62 },
                    { x: new Date(2020, 1), y: 0.34 },
                    { x: new Date(2020, 2), y: 0.41 },
                    { x: new Date(2020, 3), y: 0.16 },
                    { x: new Date(2020, 4), y: 0.40 },
                    { x: new Date(2020, 5), y: 0.55 },
                    { x: new Date(2020, 6), y: 0.64 },
                    { x: new Date(2020, 7), y: 0 },
                    { x: new Date(2020, 8), y: 0 },
                    { x: new Date(2020, 9), y: 0 },
                    { x: new Date(2020, 10), y: 0 },
    ...
    var chart1 = new CanvasJS.Chart("alcanceMegusta", {
        ...
        data: [{
                ...
                dataPoints: [
                    ...
                    { x: new Date(2020, 5), y: 14342 },
                    { x: new Date(2020, 6), y: 15759 },
                    { x: new Date(2020, 7), y: 0 },
                    { x: new Date(2020, 8), y: 0 },
                    { x: new Date(2020, 9), y: 0 },
                    { x: new Date(2020, 10), y: 0 },
            ...
            },
            {
                ...
                dataPoints: [
                    ...
                    { x: new Date(2020, 5), y: 456 },
                    { x: new Date(2020, 6), y: 499 },
                    { x: new Date(2020, 7), y: 0 },
                    { x: new Date(2020, 8), y: 0 },
                    { x: new Date(2020, 9), y: 0 },
                    { x: new Date(2020, 10), y: 0 },
            ...
            },
            {
                ...
                dataPoints: [
                    ...
                    { x: new Date(2020, 5), y: 16369 },
                    { x: new Date(2020, 6), y: 17491 },
                    { x: new Date(2020, 7), y: 0 },
                    { x: new Date(2020, 8), y: 0 },
                    { x: new Date(2020, 9), y: 0 },
                    { x: new Date(2020, 10), y: 0 },
    ...
    var chart2 = new CanvasJS.Chart("seguidores", {
        ...
        data: [{
                ...
                dataPoints: [
                    ...
                    { x: new Date(2020, 5), y: 5779 },
                    { x: new Date(2020, 6), y: 5764 },
                    { x: new Date(2020, 7), y: 0 },
                    { x: new Date(2020, 8), y: 0 },
                    { x: new Date(2020, 9), y: 0 },
                    { x: new Date(2020, 10), y: 0 },
    ...
    var chart3 = new CanvasJS.Chart("mensajesPublicaciones", {
        ...
        data: [{
                ...
                dataPoints: [
                    ...
                    { x: new Date(2020, 5), y: 32 },
                    { x: new Date(2020, 6), y: 37 },
                    { x: new Date(2020, 7), y: 0 },
                    { x: new Date(2020, 8), y: 0 },
                    { x: new Date(2020, 9), y: 0 },
                    { x: new Date(2020, 10), y: 0 },
    ...
    var chart4 = new CanvasJS.Chart("interaccionesPublicaciones", {
        ...
        data: [{
            ...
            dataPoints: [
                ...
                { x: new Date(2020, 5), y: 488 },
                { x: new Date(2020, 6), y: 536 },
                { x: new Date(2020, 7), y: 0 },
                { x: new Date(2020, 8), y: 0 },
                { x: new Date(2020, 9), y: 0 },
                { x: new Date(2020, 10), y: 0 },
    ...
    var chart5 = new CanvasJS.Chart("instaStories", {
        ...
        data: [{
                ...
                dataPoints: [
                    ...
                    { x: new Date(2020, 5), y: 5160 },
                    { x: new Date(2020, 6), y: 3858 },
                    { x: new Date(2020, 7), y: 0 },
                    { x: new Date(2020, 8), y: 0 },
                    { x: new Date(2020, 9), y: 0 },
                    { x: new Date(2020, 10), y: 0 },
...

            {
                ...
                dataPoints: [
                    ...
                    { x: new Date(2020, 5), y: 47 },
                    { x: new Date(2020, 6), y: 38 },
                    { x: new Date(2020, 7), y: 0 },
                    { x: new Date(2020, 8), y: 0 },
                    { x: new Date(2020, 9), y: 0 },
                    { x: new Date(2020, 10), y: 0 },
