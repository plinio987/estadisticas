    ...
    var chart1 = new CanvasJS.Chart("engagement", {
        ...
        data: [{
                ...
                dataPoints: [
                    ...
                    { x: new Date(2020, 5), y: 9.05 },
                    { x: new Date(2020, 6), y: 11.00 },
...

            {
                ...
                dataPoints: [
                    ...
                    { x: new Date(2020, 5), y: 1.21 },
                    { x: new Date(2020, 6), y: 0.92 },
                    { x: new Date(2020, 7), y: 0 },
                    { x: new Date(2020, 8), y: 0 },
                    { x: new Date(2020, 9), y: 0 },
                    { x: new Date(2020, 10), y: 0 },
    ...
    var chart22 = new CanvasJS.Chart("alcance", {
        ...
        data: [{
            ...
            dataPoints: [
                ...
                { x: new Date(2020, 5), y: 39000 },
                { x: new Date(2020, 6), y: 64000 },
                { x: new Date(2020, 7), y: 0 },
                { x: new Date(2020, 8), y: 0 },
                { x: new Date(2020, 9), y: 0 },
                { x: new Date(2020, 10), y: 0 },
        ...
        data: [{
...

            {
                ...
                dataPoints: [
                    ...
                    { x: new Date(2020, 5), y: 5195 },
                    { x: new Date(2020, 6), y: 5338 },
                    { x: new Date(2020, 7), y: 0 },
                    { x: new Date(2020, 8), y: 0 },
                    { x: new Date(2020, 9), y: 0 },
                    { x: new Date(2020, 10), y: 0 },
    ...
    var chart3 = new CanvasJS.Chart("interacciones", {
        ...
        data: [{
                ...
                dataPoints: [
                    ...
                    { x: new Date(2020, 5), y: 470 },
                    { x: new Date(2020, 6), y: 587 },
                    { x: new Date(2020, 7), y: 0 },
                    { x: new Date(2020, 8), y: 0 },
                    { x: new Date(2020, 9), y: 0 },
                    { x: new Date(2020, 10), y: 0 },
...

            {
                ...
                dataPoints: [
                    ...
                    { x: new Date(2020, 5), y: 55 },
                    { x: new Date(2020, 6), y: 84 },
                    { x: new Date(2020, 7), y: 0 },
                    { x: new Date(2020, 8), y: 0 },
                    { x: new Date(2020, 9), y: 0 },
                    { x: new Date(2020, 10), y: 0 },
    ...
    var chart5 = new CanvasJS.Chart("visitasMenciones", {
        ...
        data: [{
                ...
                dataPoints: [
                    ...
                    { x: new Date(2020, 5), y: 1937 },
                    { x: new Date(2020, 6), y: 2203 },
                    { x: new Date(2020, 7), y: 0 },
                    { x: new Date(2020, 8), y: 0 },
                    { x: new Date(2020, 9), y: 0 },
                    { x: new Date(2020, 10), y: 0 },
