  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Dashboard Portal web Progresando con Solidaridad</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <?php include('include/prosoli-header-portal.php'); ?>
...
<script type="text/javascript" src="charts\prosoli\chartsPortalWeb.js"></script>
