window.onload = function() {
    ...
    var chart20 = new CanvasJS.Chart("engagementIGVice", {
        ...
        data: [{
            ...
            dataPoints: [
                { x: new Date(2019, 0), y: 0.36 },
                { x: new Date(2019, 1), y: 0.41 },
                { x: new Date(2019, 2), y: 0.38 },
                { x: new Date(2019, 3), y: 0.38 },
                { x: new Date(2019, 4), y: 0.38 },
                { x: new Date(2019, 5), y: 0.34 },
                { x: new Date(2019, 6), y: 0.40 },
    ...
    var chart21 = new CanvasJS.Chart("nuevosSeguidoreIGVice", {
        ...
        data: [{
            ...
            yValueFormatString: "#,###",
            dataPoints: [
                { x: new Date(2019, 0), y: 94 },
                { x: new Date(2019, 1), y: 79 },
                { x: new Date(2019, 2), y: 73 },
                { x: new Date(2019, 3), y: 73 },
                { x: new Date(2019, 4), y: 53 },
                { x: new Date(2019, 5), y: 120 },
    ...
    var chart22 = new CanvasJS.Chart("nuevosMeGustaIGVice", {
        ...
        data: [{
            ...
            yValueFormatString: "#,###",
            dataPoints: [
                { x: new Date(2019, 0), y: 474 },
                { x: new Date(2019, 1), y: 584 },
                { x: new Date(2019, 2), y: 670 },
                { x: new Date(2019, 3), y: 553 },
                { x: new Date(2019, 4), y: 591 },
                { x: new Date(2019, 5), y: 641 },
                { x: new Date(2019, 6), y: 641 },
                { x: new Date(2019, 7), y: 0 },
                { x: new Date(2019, 8), y: 0 },
                { x: new Date(2019, 9), y: 0 },
                { x: new Date(2019, 10), y: 0 },
    ...
    var chart24 = new CanvasJS.Chart("interraccionesIGVice", {
        ...
        data: [{
            ...
            yValueFormatString: "#,###",
            dataPoints: [
                { x: new Date(2019, 0), y: 520 },
                { x: new Date(2019, 1), y: 621 },
                { x: new Date(2019, 2), y: 737 },
                { x: new Date(2019, 3), y: 633 },
                { x: new Date(2019, 4), y: 658 },
                { x: new Date(2019, 5), y: 722 },
                { x: new Date(2019, 6), y: 762 },
                { x: new Date(2019, 7), y: 0 },
                { x: new Date(2019, 8), y: 0 },
                { x: new Date(2019, 9), y: 0 },
                { x: new Date(2019, 10), y: 0 },
    ...
    var chart25 = new CanvasJS.Chart("IGTotalSeguidores", {
        ...
        data: [{
            ...
            yValueFormatString: "#,###",
            dataPoints: [
                { x: new Date(2019, 0), y: 1445 },
                { x: new Date(2019, 1), y: 1524 },
                { x: new Date(2019, 2), y: 1597 },
                { x: new Date(2019, 3), y: 1670 },
                { x: new Date(2019, 4), y: 1723 },
                { x: new Date(2019, 5), y: 1843 },
                { x: new Date(2019, 6), y: 1894 },
                { x: new Date(2019, 7), y: 0 },
                { x: new Date(2019, 8), y: 0 },
                { x: new Date(2019, 9), y: 0 },
                { x: new Date(2019, 10), y: 0 },
