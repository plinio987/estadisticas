    ...
    var Z = {},
        ...
        sa = {
            ...
            CultureInfo: {
                ...
                shortDays: "Lun Mar Mier Jue Vie Sab Dom".split(" "),
                months: "Enero Febrero Marzo Abril Mayo Junio Julio Agosto Septiembre Octubre Noviembre Diciembre".split(" "),
                shortMonths: "Ene Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" ")
            }
        },
        Ka = {
            en: {}
    ...
    var Va = {},
        ...
        Ba = function() {
            var m = /D{1,4}|M{1,4}|Y{1,4}|h{1,2}|H{1,2}|m{1,2}|s{1,2}|f{1,3}|t{1,2}|T{1,2}|K|z{1,3}|"[^"]*"|'[^']*'/g,
                s = "Lunes Martes Miercoles Jueves Viernes Sabado Domingo".split(" "),
                q = "Lun Mar Mier Jue Vier Sab Dom".split(" "),
                v = "Enero Febrero Marzo Abril Mayo Junio Julio agosto Septiembre Octubre Noviembre Diciembre".split(" "),
                y = "Ene Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),
