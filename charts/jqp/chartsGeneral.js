window.onload = function() {
    ...
    var chart1 = new CanvasJS.Chart("alcanceGeneral", {
        ...
        data: [{
                ...
                dataPoints: [
                    ...
                    { x: new Date(2020, 2), y: 53.46 },
                    { x: new Date(2020, 3), y: 76.86 },
                    { x: new Date(2020, 4), y: 104.79 },
                    { x: new Date(2020, 5), y: 107.57 },
                    { x: new Date(2020, 6), y: 133.38 },
...

            {
                ...
                yValueFormatString: "#,###",
                dataPoints: [
                    { x: new Date(2020, 0), y: 6939 },
                    { x: new Date(2020, 1), y: 12787 },
    ...
    var chart2 = new CanvasJS.Chart("totalSeguidores", {
        ...
        data: [{
            ...
            yValueFormatString: "#,###",
            dataPoints: [
                { x: new Date(2020, 0), y: 634 },
                { x: new Date(2020, 1), y: 707 },
                { x: new Date(2020, 2), y: 856 },
                { x: new Date(2020, 3), y: 1102 },
