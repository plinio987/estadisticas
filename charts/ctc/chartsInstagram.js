window.onload = function() {
    ...
    var chart20 = new CanvasJS.Chart("averagelikes", {
        ...
        data: [{
                ...
                xValueFormatString: "MMMM YYYY",
                dataPoints: [
                    { x: new Date(2020, 0), y: 25.63 },
                    { x: new Date(2020, 1), y: 22.39 },
                    { x: new Date(2020, 2), y: 32.63 },
                    { x: new Date(2020, 3), y: 47.67 },
                    { x: new Date(2020, 4), y: 141.59 },
                    { x: new Date(2020, 5), y: 22.21 },
                    { x: new Date(2020, 6), y: 0 },
                    { x: new Date(2020, 7), y: 0 },
                    { x: new Date(2020, 8), y: 0 },
                    { x: new Date(2020, 9), y: 0 },
...

            {
                ...
                dataPoints: [
                    ...
                    { x: new Date(2020, 1), y: 0.87 },
                    { x: new Date(2020, 2), y: 2.53 },
                    { x: new Date(2020, 3), y: 2.40 },
                    { x: new Date(2020, 4), y: 3.57 },
                    { x: new Date(2020, 5), y: 0.81 },
                    { x: new Date(2020, 6), y: 0 },
                    { x: new Date(2020, 7), y: 0 },
                    { x: new Date(2020, 8), y: 0 },
                    { x: new Date(2020, 9), y: 0 },
