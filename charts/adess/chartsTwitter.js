...
window.onload = function() {
    ...
    var chart1 = new CanvasJS.Chart("engagement", {
        ...
        data: [{
                ...
                dataPoints: [
                    ...
                    { x: new Date(2020, 5), y: 42.34 },
                    { x: new Date(2020, 6), y: 56.83 },
    ...
    var chart22 = new CanvasJS.Chart("alcance", {
        ...
        data: [{
            ...
            dataPoints: [
                ...
                { x: new Date(2020, 5), y: 19000 },
                { x: new Date(2020, 6), y: 23800 },
                { x: new Date(2020, 7), y: 0 },
                { x: new Date(2020, 8), y: 0 },
                { x: new Date(2020, 9), y: 0 },
                { x: new Date(2020, 10), y: 0 },
    ...
    var chart2 = new CanvasJS.Chart("seguidores", {
        ...
        data: [{
                ...
                dataPoints: [
                    ...
                    { x: new Date(2020, 5), y: 144 },
                    { x: new Date(2020, 6), y: 274 },
                    { x: new Date(2020, 7), y: 0 },
                    { x: new Date(2020, 8), y: 0 },
                    { x: new Date(2020, 9), y: 0 },
                    { x: new Date(2020, 10), y: 0 },
...

            {
                ...
                dataPoints: [
                    ...
                    { x: new Date(2020, 5), y: 3073 },
                    { x: new Date(2020, 6), y: 3347 },
                    { x: new Date(2020, 7), y: 0 },
                    { x: new Date(2020, 8), y: 0 },
                    { x: new Date(2020, 9), y: 0 },
                    { x: new Date(2020, 10), y: 0 },
    ...
    var chart3 = new CanvasJS.Chart("interacciones", {
        ...
        data: [{
                ...
                dataPoints: [
                    ...
                    { x: new Date(2020, 5), y: 1301 },
                    { x: new Date(2020, 6), y: 1902 },
                    { x: new Date(2020, 7), y: 0 },
                    { x: new Date(2020, 8), y: 0 },
                    { x: new Date(2020, 9), y: 0 },
                    { x: new Date(2020, 10), y: 0 },
...

            {
                ...
                dataPoints: [
                    ...
                    { x: new Date(2020, 5), y: 67 },
                    { x: new Date(2020, 6), y: 85 },
                    { x: new Date(2020, 7), y: 0 },
                    { x: new Date(2020, 8), y: 0 },
                    { x: new Date(2020, 9), y: 0 },
                    { x: new Date(2020, 10), y: 0 },
    ...
    var chart4 = new CanvasJS.Chart("crrm", {
        ...
        data: [{
            ...
            dataPoints: [
                { y: 700, label: "Clicks" },
                { y: 656, label: "Me gusta" },
                { y: 171, label: "Retuits" },
                { y: 106, label: "Respuestas" }
    ...
    var chart5 = new CanvasJS.Chart("visitasMenciones", {
        ...
        data: [{
                ...
                dataPoints: [
                    ...
                    { x: new Date(2020, 5), y: 9370 },
                    { x: new Date(2020, 6), y: 10239 },
                    { x: new Date(2020, 7), y: 0 },
                    { x: new Date(2020, 8), y: 0 },
                    { x: new Date(2020, 9), y: 0 },
                    { x: new Date(2020, 10), y: 0 },
...

            {
                ...
                dataPoints: [
                    ...
                    { x: new Date(2020, 5), y: 246 },
                    { x: new Date(2020, 6), y: 185 },
                    { x: new Date(2020, 7), y: 0 },
                    { x: new Date(2020, 8), y: 0 },
                    { x: new Date(2020, 9), y: 0 },
                    { x: new Date(2020, 10), y: 0 },
