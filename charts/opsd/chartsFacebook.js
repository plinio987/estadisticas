window.onload = function() {
    ...
    var chart1 = new CanvasJS.Chart("engagement", {
        ...
        data: [{
                ...
                dataPoints: [
                    { x: new Date(2020, 0), y: 2.90 },
                    { x: new Date(2020, 1), y: 2.04 },
                    { x: new Date(2020, 2), y: 3.17 },
                    { x: new Date(2020, 3), y: 3.21 },
                    { x: new Date(2020, 4), y: 2.62 },
...

            {
                ...
                yValueFormatString: "###0.00'%'",
                dataPoints: [
                    { x: new Date(2020, 0), y: 3.70 },
                    { x: new Date(2020, 1), y: 2.00 },
                    { x: new Date(2020, 2), y: 3.57 },
                    { x: new Date(2020, 3), y: 4.69 },
                    { x: new Date(2020, 4), y: 4.37 },
                    { x: new Date(2020, 5), y: 2.50 },
                    { x: new Date(2020, 6), y: 0 },
                    { x: new Date(2020, 7), y: 0 },
                    { x: new Date(2020, 8), y: 0 },
                    { x: new Date(2020, 9), y: 0 },
    ...
    var chart2 = new CanvasJS.Chart("alcancePublicaciones", {
        ...
        data: [{
                ...
                xValueFormatString: "MMMM YYYY",
                dataPoints: [
                    { x: new Date(2020, 0), y: 770 },
                    { x: new Date(2020, 1), y: 660 },
                    { x: new Date(2020, 2), y: 643 },
                    { x: new Date(2020, 3), y: 1080 },
                    { x: new Date(2020, 4), y: 943 },
...

            {
                ...
                yValueFormatString: "#,###",
                dataPoints: [
                    { x: new Date(2020, 0), y: 12068 },
                    { x: new Date(2020, 1), y: 9324 },
                    { x: new Date(2020, 2), y: 10716 },
                    { x: new Date(2020, 3), y: 12118 },
                    { x: new Date(2020, 4), y: 16032 },
                    { x: new Date(2020, 5), y: 12454 },
                    { x: new Date(2020, 6), y: 0 },
                    { x: new Date(2020, 7), y: 0 },
                    { x: new Date(2020, 8), y: 0 },
                    { x: new Date(2020, 9), y: 0 },
    ...
    var chart3 = new CanvasJS.Chart("seguidores", {
        ...
        data: [{
...

            {
                ...
                yValueFormatString: "#,###",
                dataPoints: [
                    { x: new Date(2020, 0), y: 947 },
                    { x: new Date(2020, 1), y: 949 },
                    { x: new Date(2020, 2), y: 952 },
                    { x: new Date(2020, 3), y: 959 },
                    { x: new Date(2020, 4), y: 961 },
    ...
    var chart8 = new CanvasJS.Chart("facebookPorcentajeParticipacion", {
        ...
        data: [{
            ...
            yValueFormatString: "##0.00'%'",
            dataPoints: [
                { x: new Date(2020, 0), y: 2.19 },
                { x: new Date(2020, 1), y: 1.73 },
                { x: new Date(2020, 2), y: 2.43 },
                { x: new Date(2020, 3), y: 3.00 },
                { x: new Date(2020, 4), y: 2.10 },
                { x: new Date(2020, 5), y: 1.85 },
                { x: new Date(2020, 6), y: 0 },
                { x: new Date(2020, 7), y: 0 },
                { x: new Date(2020, 8), y: 0 },
                { x: new Date(2020, 9), y: 0 },
