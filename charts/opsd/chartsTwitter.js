...
window.onload = function() {
    ...
    var chart1 = new CanvasJS.Chart("engagement", {
        ...
        data: [{
                ...
                dataPoints: [
                    { x: new Date(2020, 0), y: 2.62 },
                    { x: new Date(2020, 1), y: 4.71 },
                    { x: new Date(2020, 2), y: 3.00 },
                    { x: new Date(2020, 3), y: 7.38 },
                    { x: new Date(2020, 4), y: 3.54 },
                    { x: new Date(2020, 5), y: 2.48 },
...

            {
                ...
                dataPoints: [
                    ...
                    { x: new Date(2020, 1), y: 0.94 },
                    { x: new Date(2020, 2), y: 0.66 },
                    { x: new Date(2020, 3), y: 1.14 },
                    { x: new Date(2020, 4), y: 0.41 },
                    { x: new Date(2020, 5), y: 0.89 },
                    { x: new Date(2020, 6), y: 0 },
                    { x: new Date(2020, 7), y: 0 },
                    { x: new Date(2020, 8), y: 0 },
                    { x: new Date(2020, 9), y: 0 },
    ...
    var chart22 = new CanvasJS.Chart("alcance", {
        ...
        data: [{
            ...
            yValueFormatString: "#,###",
            dataPoints: [
                { x: new Date(2020, 0), y: 5166 },
                { x: new Date(2020, 1), y: 5220 },
                { x: new Date(2020, 2), y: 4677 },
                { x: new Date(2020, 3), y: 6773 },
                { x: new Date(2020, 4), y: 8932 },
                { x: new Date(2020, 5), y: 4383 },
                { x: new Date(2020, 6), y: 0 },
                { x: new Date(2020, 7), y: 0 },
                { x: new Date(2020, 8), y: 0 },
                { x: new Date(2020, 9), y: 0 },
    ...
    var chart2 = new CanvasJS.Chart("seguidores", {
        ...
        data: [{
...

            {
                ...
                yValueFormatString: "#,###",
                dataPoints: [
                    { x: new Date(2020, 0), y: 1029 },
                    { x: new Date(2020, 1), y: 1040 },
                    { x: new Date(2020, 2), y: 1034 },
                    { x: new Date(2020, 3), y: 1044 },
                    { x: new Date(2020, 4), y: 1045 },
                    { x: new Date(2020, 5), y: 1047 },
                    { x: new Date(2020, 6), y: 0 },
                    { x: new Date(2020, 7), y: 0 },
                    { x: new Date(2020, 8), y: 0 },
                    { x: new Date(2020, 9), y: 0 },
    ...
    var chart5 = new CanvasJS.Chart("visitasMenciones", {
        ...
        data: [{
                ...
                dataPoints: [
                    ...
                    { x: new Date(2020, 1), y: 124 },
                    { x: new Date(2020, 2), y: 100 },
                    { x: new Date(2020, 3), y: 127 },
                    { x: new Date(2020, 4), y: 139 },
...

            {
                ...
                dataPoints: [
                    ...
                    { x: new Date(2020, 1), y: 13 },
                    { x: new Date(2020, 2), y: 14 },
                    { x: new Date(2020, 3), y: 53 },
