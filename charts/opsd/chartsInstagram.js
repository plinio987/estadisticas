window.onload = function() {
    ...
    var chart = new CanvasJS.Chart("engagement", {
        ...
        data: [{
                ...
                dataPoints: [
                    { x: new Date(2020, 0), y: 4.11 },
                    { x: new Date(2020, 1), y: 3.22 },
                    { x: new Date(2020, 2), y: 2.93 },
                    { x: new Date(2020, 3), y: 5.04 },
                    { x: new Date(2020, 4), y: 5.48 },
                    { x: new Date(2020, 5), y: 4.05 },
...

            {
                ...
                yValueFormatString: "###0.00'%'",
                dataPoints: [
                    { x: new Date(2020, 0), y: 6.64 },
                    { x: new Date(2020, 1), y: 2.37 },
                    { x: new Date(2020, 2), y: 2.73 },
                    { x: new Date(2020, 3), y: 2.95 },
                    { x: new Date(2020, 4), y: 2.82 },
                    { x: new Date(2020, 5), y: 2.86 },
                    { x: new Date(2020, 6), y: 0 },
                    { x: new Date(2020, 7), y: 0 },
                    { x: new Date(2020, 8), y: 0 },
                    { x: new Date(2020, 9), y: 0 },
    ...
    var chart1 = new CanvasJS.Chart("alcanceMegusta", {
        ...
        data: [{
                ...
                xValueFormatString: "MMMM YYYY",
                dataPoints: [
                    { x: new Date(2020, 0), y: 2019 },
                    { x: new Date(2020, 1), y: 4428 },
                    { x: new Date(2020, 2), y: 3515 },
                    { x: new Date(2020, 3), y: 5622 },
                    { x: new Date(2020, 4), y: 6388 },
                    { x: new Date(2020, 5), y: 4643 },
                    { x: new Date(2020, 6), y: 0 },
                    { x: new Date(2020, 7), y: 0 },
                    { x: new Date(2020, 8), y: 0 },
                    { x: new Date(2020, 9), y: 0 },
...

            {
                ...
                dataPoints: [
                    ...
                    { x: new Date(2020, 2), y: 94 },
                    { x: new Date(2020, 3), y: 166 },
                    { x: new Date(2020, 4), y: 175 },
                    { x: new Date(2020, 5), y: 133 },
                    { x: new Date(2020, 6), y: 0 },
                    { x: new Date(2020, 7), y: 0 },
                    { x: new Date(2020, 8), y: 0 },
                    { x: new Date(2020, 9), y: 0 },
    ...
    var chart2 = new CanvasJS.Chart("seguidores", {
        ...
        data: [{
                ...
                xValueFormatString: "MMMM YYYY",
                dataPoints: [
                    { x: new Date(2020, 0), y: 3260 },
                    { x: new Date(2020, 1), y: 3260 },
                    { x: new Date(2020, 2), y: 3273 },
                    { x: new Date(2020, 3), y: 3294 },
                    { x: new Date(2020, 4), y: 3282 },
                    { x: new Date(2020, 5), y: 3284 },
                    { x: new Date(2020, 6), y: 0 },
                    { x: new Date(2020, 7), y: 0 },
                    { x: new Date(2020, 8), y: 0 },
                    { x: new Date(2020, 9), y: 0 },
...

            {
                ...
                dataPoints: [
                    ...
                    { x: new Date(2020, 3), y: 21 },
                    { x: new Date(2020, 4), y: -12 },
    ...
    var chart4 = new CanvasJS.Chart("interaccionesPublicaciones", {
        ...
        data: [{
            ...
            color: "#D6618F",
            dataPoints: [
                { x: new Date(2020, 0), y: 134 },
                { x: new Date(2020, 1), y: 105 },
                { x: new Date(2020, 2), y: 96 },
                { x: new Date(2020, 3), y: 166 },
                { x: new Date(2020, 4), y: 180 },
                { x: new Date(2020, 5), y: 133 },
                { x: new Date(2020, 6), y: 0 },
                { x: new Date(2020, 7), y: 0 },
                { x: new Date(2020, 8), y: 0 },
    ...
    var chart5 = new CanvasJS.Chart("instaStories", {
        ...
        data: [{
                ...
                xValueFormatString: "MMMM YYYY",
                dataPoints: [
                    { x: new Date(2020, 0), y: 240 },
                    { x: new Date(2020, 1), y: 240 },
                    { x: new Date(2020, 2), y: 980 },
                    { x: new Date(2020, 3), y: 161 },
                    { x: new Date(2020, 4), y: 181 },
                    { x: new Date(2020, 5), y: 311 },
                    { x: new Date(2020, 6), y: 0 },
                    { x: new Date(2020, 7), y: 0 },
                    { x: new Date(2020, 8), y: 0 },
                    { x: new Date(2020, 9), y: 0 },
