window.onload = function() {
    ...
    var chart2 = new CanvasJS.Chart("sistemasOperativos", {
        ...
        data: [{
            ...
            click: explodePie,
            dataPoints: [
                { y: 59.58, label: "Windows" },
                { y: 20.21, label: "Android" },
                { y: 18.12, label: "iOS" },
                { y: 0.35, label: "Linux" },
                { y: 1.74, label: "Not Set" }
            ]
        }]
    });
    ...
    var chart3 = new CanvasJS.Chart("navegadores", {
        ...
        data: [{
            ...
            click: explodePie,
            dataPoints: [
                { y: 69.34, label: "Chrome" },
                { y: 10.98, label: "Safari" },
                { y: 2.09, label: "Android" },
                { y: 10.20, label: "Edge/Explorer" },
                { y: 4.01, label: "Firefox" },
                { y: 2.22, label: "Not set" }
    ...
    var chart4 = new CanvasJS.Chart("moviles", {
        ...
        data: [{
            ...
            click: explodePie,
            dataPoints: [
                { y: 29.07, label: "iPhone" },
                { y: 2.33, label: "Alcatel" },
                { y: 2.33, label: "Huawei" },
                { y: 2.33, label: "LG" },
                { y: 2.33, label: "ZTE" },
                { y: 1.16, label: "Not Set" }
            ]
        }]
    });
    chart4.render();
    ...
    var chart7 = new CanvasJS.Chart("dispositivos", {
        ...
        data: [{
            ...
            click: explodePie,
            dataPoints: [
                { y: 70.03, label: "Desktop" },
                { y: 28.75, label: "Mobile" },
                { y: 1.22, label: "Tablet" }
            ]
        }]
    });
    ...
    var chart12 = new CanvasJS.Chart("redesSociales", {
        ...
        data: [{
            ...
            dataPoints: [
                { y: 53.85, label: "Facebook" },
                { y: 30.77, label: "Twitter" },
                { y: 15.38, label: "Instagram" }
            ]
        }]
    });
    chart12.render();
