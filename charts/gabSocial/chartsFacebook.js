window.onload = function() {
    ...
    var chart1 = new CanvasJS.Chart("engagement", {
        ...
        data: [{
                ...
                dataPoints: [
                    { x: new Date(2020, 0), y: 55.26 },
                    { x: new Date(2020, 1), y: 95.77 },
                    { x: new Date(2020, 2), y: 46.07 },
                    { x: new Date(2020, 3), y: 50.84 },
...

            {
                ...
                yValueFormatString: "###0.00'%'",
                dataPoints: [
                    { x: new Date(2020, 0), y: 81.75 },
                    { x: new Date(2020, 1), y: 94.16 },
                    { x: new Date(2020, 2), y: 12.45 },
                    { x: new Date(2020, 3), y: 55.19 },
    ...
    var chart8 = new CanvasJS.Chart("facebookPorcentajeParticipacion", {
        ...
        data: [{
            ...
            yValueFormatString: "##0.00'%'",
            dataPoints: [
                { x: new Date(2020, 0), y: 3.43 },
                { x: new Date(2020, 1), y: 3.82 },
                { x: new Date(2020, 2), y: 1.86 },
                { x: new Date(2020, 3), y: 5.65 },
                { x: new Date(2020, 4), y: 13.93 },
                { x: new Date(2020, 5), y: 0 },
                { x: new Date(2020, 6), y: 0 },
                { x: new Date(2020, 7), y: 0 },
                { x: new Date(2020, 8), y: 0 },
