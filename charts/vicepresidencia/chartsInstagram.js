window.onload = function() {
    ...
    var chart20 = new CanvasJS.Chart("averagelikes", {
        ...
        data: [{
                ...
                xValueFormatString: "MMMM YYYY",
                dataPoints: [
                    { x: new Date(2020, 0), y: 12.41 },
                    { x: new Date(2020, 1), y: 12.49 },
                    { x: new Date(2020, 2), y: 7.17 },
                    { x: new Date(2020, 3), y: 40.67 },
                    { x: new Date(2020, 4), y: 24.27 },
                    { x: new Date(2020, 5), y: 17.09 },
                    { x: new Date(2020, 6), y: 0 },
                    { x: new Date(2020, 7), y: 0 },
                    { x: new Date(2020, 8), y: 0 },
                    { x: new Date(2020, 9), y: 0 },
...

            {
                ...
                yValueFormatString: "###0.00'%'",
                dataPoints: [
                    { x: new Date(2020, 0), y: 0.25 },
                    { x: new Date(2020, 1), y: 0.29 },
                    { x: new Date(2020, 2), y: 0.35 },
                    { x: new Date(2020, 3), y: 10.19 },
                    { x: new Date(2020, 4), y: 2.92 },
                    { x: new Date(2020, 5), y: 1.69 },
                    { x: new Date(2020, 6), y: 0 },
                    { x: new Date(2020, 7), y: 0 },
                    { x: new Date(2020, 8), y: 0 },
                    { x: new Date(2020, 9), y: 0 },
