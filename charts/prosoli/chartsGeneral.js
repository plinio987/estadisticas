window.onload = function() {
    ...
    var chart2 = new CanvasJS.Chart("totalSeguidores", {
        ...
        data: [{
            ...
            dataPoints: [
                { x: new Date(2020, 0), y: 3.82 },
                { x: new Date(2020, 1), y: 5.28 },
                { x: new Date(2020, 2), y: 7.25 },
                { x: new Date(2020, 3), y: 5.23 },
                { x: new Date(2020, 4), y: 4.27 },
                { x: new Date(2020, 5), y: 6.97 },
                { x: new Date(2020, 6), y: 4.70 },
                { x: new Date(2020, 7), y: 0 },
                { x: new Date(2020, 8), y: 0 },
                { x: new Date(2020, 9), y: 0 },
                { x: new Date(2020, 10), y: 0 },
