window.onload = function() {
    ...
    var chart1 = new CanvasJS.Chart("visitasPortalVice", {
        ...
        data: [{
                ...
                dataPoints: [
                    { x: new Date(2020, 0), y: 17772 },
                    { x: new Date(2020, 1), y: 13598 },
            ...
            },
            {
                ...
                yValueFormatString: "##,##0",
                dataPoints: [
                    { x: new Date(2020, 0), y: 5287 },
                    { x: new Date(2020, 1), y: 4415 },
            ...
            },
            {
                ...
                yValueFormatString: "##,##0",
                dataPoints: [
                    { x: new Date(2020, 0), y: 4313 },
                    { x: new Date(2020, 1), y: 3605 },
    ...
    var chart16 = new CanvasJS.Chart("porcentajeRebote", {
        ...
        data: [{
            ...
            dataPoints: [
                { x: new Date(2020, 0), y: 46.70 },
                { x: new Date(2020, 1), y: 51.33 },
    ...
    var chart8 = new CanvasJS.Chart("tiempoDuracion", {
        ...
        data: [{
            ...
            dataPoints: [
                { x: new Date(2020, 0), y: 239 },
                { x: new Date(2020, 1), y: 226 },
    ...
    var chart20 = new CanvasJS.Chart("usersSplinePortal", {
        ...
        data: [{
                ...
                dataPoints: [
                    { x: new Date(2020, 0), y: 81.70 },
                    { x: new Date(2020, 1), y: 80.70 },
...

            {
                ...
                name: "Recurrentes",
                dataPoints: [
                    { x: new Date(2020, 0), y: 18.30 },
                    { x: new Date(2020, 1), y: 19.30 },
